...
use app\admin\model\xshop\Terms;
...
class Product extends Base
{
    ...
    protected $multiFields = 'home_recommend,category_recommend,on_sale';
    ...
    public function _initialize()
    {
        ...
        $tremsList = Terms::getList();
        $this->assign('tremsList', $tremsList);
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $row) {
                $row->visible(['id', 'title', 'fans', 'favorite_count', 'description', 'content', 'image', 'on_sale', 'rating', 'sold_count', 'review_count', 'price', 'market_price', 'sold_time_start', 'sold_time_end', 'sold_time_tips', 'create_time', 'home_recommend', 'category_recommend', 'service_tags']);
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                $params['trems_ids'] = implode(',', $params['trems_ids']);
                $params['notice_ids'] = implode(',', $params['notice_ids']);
        ...
        $this->view->assign('skus', json_encode($skus));
    ...
    public function edit($ids = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if ($result !== false) {
                    ...
                    \think\Hook::listen('xshop_product_after_save', $payload);
                    $this->success();
                } else {
        ...
        \think\Hook::listen('xshop_admin_product_assign', $row);
        $service_tags = ServiceTagModel::select();
        $this->assign('service_tags', $service_tags);
