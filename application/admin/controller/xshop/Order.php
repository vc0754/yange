...
class Order extends Base
{
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $row) {
                $row->visible(['fbTime','material','id','order_sn','is_pay','pay_time','is_delivery','delivery','status','contactor','contactor_phone','delivery_price','order_price','pay_price','tax_price','discount_price','payed_price', 'create_time','update_time', 'express_no', 'products_price', 'address', 'pay_type', 'pay_method', 'remark', 'order_type', 'groupon_status', 'after_saler_remark', 'after_buyer_remark', 'after_sale_status', 'refund_fee']);
                $row->visible(['user']);
